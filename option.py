...
parser.add_argument('--model-name', default='wsanodetV5_', help='name to save model')
...
parser.add_argument('--croloss-weight', type=float, default=0.1, help='weight for cross-entropy loss component (default: 5.0)')
