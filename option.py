...
# parser.add_argument('--test-rgb-list', default='list/my_RGBtest.list', help='list of test rgb features ')
# parser.add_argument('--test-flow-list', default='list/my_Flowtest.list', help='list of test flow features')
# parser.add_argument('--test-audio-list', default='list/my_Audiotest.list', help='list of test audio features')
...
parser.add_argument('--model-name', default='Enhancedv1_', help='name to save model')
...
parser.add_argument('--weights', default='Inverse', help='Adding weights to the sample data (default: Normal) Normal or Inverse')
parser.add_argument('--online-mode', default='Multi', help='Choosing the mode to train the online mode in (default: Binary) Binary or Multi')
parser.add_argument('--optimizer', default='Adam', help='Choosing the optimizer (default: Adam) Adam or SGD')
parser.add_argument('--weight-decay', type=float, default=0.0001, help='weight decay for optimizer (default: 0.0001)')
parser.add_argument('--seed', type=int, default=None, help='random seed for reproducibility (default: None)')
parser.add_argument('--grad-clip', type=float, default=None, help='gradient clipping max norm (default: None, no clipping)')
parser.add_argument('--scheduler-milestones', type=int, nargs='+', default=[15, 30], help='learning rate scheduler milestones (default: [15, 30])')
parser.add_argument('--croloss-weight', type=float, default=5.0, help='weight for cross-entropy loss component (default: 5.0)')
