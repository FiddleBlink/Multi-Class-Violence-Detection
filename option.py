...
parser.add_argument('--test-rgb-list', default='list/Analysis/my_RGBtest.list', help='list of test rgb features ')
parser.add_argument('--test-flow-list', default='list/Analysis/my_Flowtest.list', help='list of test flow features')
parser.add_argument('--test-audio-list', default='list/Analysis/my_Audiotest.list', help='list of test audio features')
...
parser.add_argument('--batch-size', type=int, default=256, help='number of instances in a batch of data (default: 128)')
...
parser.add_argument('--max-seqlen', type=int, default=450, help='maximum sequence length during training (default: 750)')
...
parser.add_argument('--scoring-mode', default='Multi', help='Choosing the mode to train the online mode in (default: Binary) Binary or Multi')
